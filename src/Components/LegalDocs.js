  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Health Care <span className="legal-siteSign">+</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Health Care Plus, your trusted online healthcare platform.
          Our mission is to provide accessible and personalized healthcare
          services to individuals seeking expert medical advice and treatment.
          By using our platform, you agree to the terms outlined in our Privacy
        ...
        <p className="legal-description">
          When using Health Care Plus, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Health Care Plus is designed to simplify healthcare access. You can
          choose a specialist, schedule an appointment, and engage in a virtual
